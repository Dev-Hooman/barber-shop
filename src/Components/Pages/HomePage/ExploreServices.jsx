...
const ExploreServices = () => {
  return (
    <div>
      <div className="flex ">
        <div className="col-md-8  text-[40px]  text-[#1E1E1E] flex justify-end mt-20 ">
      ...
      <div className="container flex gap-4 mt-5">
        <div className="col-md-4 h-[155px] bg-[#C5AC80] rounded-[10px] flex">
        ...
        <div className="col-md-4 h-[155px] bg-[#FFFFFF] shadow-lg rounded-[10px] flex">
          <div className="col-4 flex justify-center items-center">
        ...
        <div className="col-md-4 h-[155px] bg-[#C5AC80] rounded-[10px] flex">
          <div className="col-4 flex justify-center items-center">
            ...
            <div className="w-[21px] h-[21px] rounded-[6px] bg-[white] flex rotate-45 mr-5 justify-center items-center ">
              <img
                src={CircleDollar}
